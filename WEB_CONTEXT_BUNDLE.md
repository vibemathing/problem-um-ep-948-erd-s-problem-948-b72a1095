...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-948-erd-s-problem-948-b72a1095-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-948"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-948-erd-s-problem-948-b72a1095-v1",
      "problem_contract_sha256": "0a0be039fd3387fc6328b2f8eab68ec512122efc6143ec0a50c7bd07d73883b9",
      "problem_id": "problem:um-ep-948-erd-s-problem-948-b72a1095",
      "route_id": "route:um-ep-948-erd-s-problem-948-b72a1095-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-948-erd-s-problem-948-b72a1095-source-fidelity-01",
      "graph_id": "graph:um-ep-948-erd-s-problem-948-b72a1095-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-948-erd-s-problem-948-b72a1095-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-948-erd-s-problem-948-b72a1095-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is there a function $f(n)$ and a $k$ such that in any $k$-colouring of the integers there exists a sequence $a_1<\\cdots$ such that $a_n<f(n)$ for infinitely many $n$ and the set $ \\left\\{ \\sum_{i\\in S}a_i : \\textrm{finite }S\\right\\} $ does not contain all colours?"
          },
          "statement_sha256": "8c93d71353eb383729d50ddb19ca53f3e63b550c72bdc5ea22d904d9ef8602df"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-948-erd-s-problem-948-b72a1095-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-948-erd-s-problem-948-b72a1095-root",
      "route_id": "route:um-ep-948-erd-s-problem-948-b72a1095-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-948-0b634aa74589",
        "url": "https://www.unsolvedmath.com/problems/EP-948"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
